...
import { fetchExpenseCategories, addExpenseCategory } from '@/services/api';
...
const ExpenseAdd = () => {
    ...
    const loadCategories = async () => {
      ...
      if (data) {
        ...
        toast({
          ...
          description: error?.message || "Could not load expense categories.",
          variant: "destructive",
        });
      }
  ...
  const handleAddCategory = async () => {
    ...
    const { data, error } = await addExpenseCategory(newCategoryName.trim());
    if (data) {
      ...
      toast({ title: "Error", description: error?.message || "Could not add category.", variant: "destructive" });
    }
  };
      ...
      <Dialog open={isAddCategoryDialogOpen} onOpenChange={setIsAddCategoryDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Enter the name for the new expense category.
            </DialogDescription>
          </DialogHeader>
